return {
  ...
  --event = { "BufReadPost", "BufNewFile" }, -- Carica solo all'apertura di un file
  ...
  config = function()
    vim.ui.open = (function(overridden)
      return function(uri, opt)
        ...
        -- TODO: Aggiungere gli altri opens ...
    ...
    require('obsidian').setup({
      ui = {
        enable = false,  -- Spegni questo! Render-markdown è superiore.
      },
      ...
      -- NOTE: Deprecated: https://github.com/obsidian-nvim/obsidian.nvim/wiki/Keymaps
      --mappings = {
      ...
      -- Do not activate, use render.markdown.nvim
